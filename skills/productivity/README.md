...
- **[xyz-venture-handoff](./xyz-venture-handoff/SKILL.md)** — Onboard a Claude agent (or human) to a specific XYZ venture. Builds on `handoff` with XYZ-specific context.
